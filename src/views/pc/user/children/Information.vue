    ...
    <y-shelf title="账户资料">
      <div slot="content">
        <div class="avatar-box">
          <div class=img-box><img :src="userInfo.headPic ? userInfo.headPic : url" alt=""></div>
          <div class="r-box">
            <h3>修改头像</h3>
            <input
              class="main-btn"
          ...
          <span class="close" @click="editAvatarShow=false">
            ...
            <div slot="content" class="content">
              ...
              <div class="bootom-btn pa">
                <y-button style="width: 140px;height: 40px;line-height: 40px;margin-bottom: 20px;"
                          text="取消"
...
<script>
  ...
  import { upload, updateHeadImage } from '/api/user'
  ...
  export default {
    ...
    methods: {
      ...
      update (e) {
        ...
        console.log(this.$refs.headImage)
        ...
        upload(param, config)
          .then(response=>{
            if (response.data.code === '0') {
              this.dataBase.top_alert('上传图像成功', true, 2000)
              this.updateUserHeadPic(response.data.data)
            } else {
              this.dataBase.top_alert('上传头像失败', false, 2000)
            }
